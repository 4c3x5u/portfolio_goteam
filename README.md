...
I am happy with the extent to which this app servers to demonstrate my Python/Django and React knowledge. However, there are some features that I think could be implemented, which would make the app serve this purpose to an even greater degree. Please visit the [issues](https://github.com/alicandev/portfolio_goteam/issues) section to see what more I plan on doing with this app.
