    ...
    <Col id="HelpModal" xs={4}>
      ...
      {modalOn && (
        <button
          ...
          onClick={toggleModal}
          onKeyDown={(e) => e.key === 'esc' && toggleModal}
        >
          <div className="Modal">
            <h1>Summary</h1>
            <p>
              In both the dropdowns and the inbox column, you can click the
              plus icon to add a new item,
              <br />
              and right click on items to view additional controls for that
              specific item.
            </p>
            <h1>Team Controls</h1>
            <ol>
              <li>
                Click the TEAM icon located on the navbar to toggle the Team
                drop-down menu.
              </li>
              <li>
                ...
                <br />
                and interact with items, will have a yellow tick on both sides
                of their name.
              </li>
              <li>
                Click a member to include or disclude him from the current
                board.
              </li>
              <li>
                You can click the plus icon at the bottom of the list to invite
            ...
            <ol>
              <li>
                Click the BOARDS icon located on the navbar to toggle the
            ...
            <ol>
              ...
              <li>
                Right click tasks to edit, delete, or assign team members to
                them.
              </li>
            </ol>
          </div>
